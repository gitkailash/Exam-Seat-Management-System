...
<body>
   ...
   <div class="wrapper">
      ...
      <nav id="sidebar">
         ...
         <ul class="list-items style" style="padding-left: 0px">
            ...
            <li><a href="#" id="add_room"><i class="fa fa-plus-square" aria-hidden="true"></i>Add Room</a></li>
            <li><a href="#" id="view_room"><i class="fa fa-eye" aria-hidden="true"></i>View Room</a></li>
            <div class="icons">
   ...
   <div class="content">
      <div class="view"><?php include("../view/view_room.php") ?></div>
      <div class="add">
      ...
      <script>
         $(document).ready(function() {
            $("#add_room").on("click", function() {
               $(".add").load("../add/add_room.php");
               $(".add").show();
               $(".view").hide();
            });
            $("#view_room").on("click", function() {
               $(".view").show();
               $(".add").hide();
            });
         });

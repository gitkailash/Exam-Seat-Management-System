...
<body>
    ...
    ?>
        ...
        <div class="container row border shadow-sm p-2 mb-2 bg-body rounded">
            ...
            $sql = "SELECT sp.roll_no, s.faculty, s.semester, r.room_no, r.floor, r.block FROM student s INNER JOIN seat_plan sp ON s.roll_no=sp.roll_no INNER JOIN room r ON r.room_id=sp.room_id ORDER BY s.roll_no";

...
<body>
    ...
    <div class="fixed-top row border shadow-sm p-1 mb-1 bg-body rounded" id="container">
        <nav class="navbar navbar-light bg-light">
            <a class="navbar-brand">Teacher Details</a>
            <form name="myForm" class="form-inline" action="#" onsubmit="return validation()" method="post">
                <input class="form-control mr-sm-2" type="search" name="username" placeholder="Teacher Name" aria-label="Search">
            ...
            <tbody>
                <tr>
                    ...
                    if (isset($_POST["search"])) {
                        ...
                        $sql_search = "SELECT * FROM teacher WHERE CONCAT(first_name,' ', last_name) LIKE '%" . $search_user . "%';";
                    ...
                    ?>
                                    <th id="update"><a href='../nav/nav_update_teacher.php? teacher_id="<?php echo ($row["teacher_id"]) ?>"' class="fa fa-pencil-square-o" aria-hidden="true">Update</a></th>
                                    <th id="delete"><a href='../delete/delete_teacher.php? teacher_id="<?php echo ($row["teacher_id"]) ?>"' class="fa fa-trash" aria-hidden="true" onclick='return check_delete()'>Delete</a></th>
                            <?php echo ("</tr>");
                                }
                            } else {
                                echo ("<th colspan='8'><h3 class='text-danger'>***No Teacher***</h3></th>");
                            }
                        }
                    } else {
                        $count = 0;
